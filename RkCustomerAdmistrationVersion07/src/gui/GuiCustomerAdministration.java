...
public class GuiCustomerAdministration {
	...
	private void addActionCommandsToButtons() {
		this.btnSaveCustomer.setActionCommand(ActionCommands.SAVE_CUSTOMER);
		this.btnShowAllCustomers.setActionCommand(ActionCommands.SHOW_ALL_CUSTOMERS);
		this.btnEditCustomer.setActionCommand(ActionCommands.EDIT_CUSTOMER);
		this.btnDeleteCustomer.setActionCommand(ActionCommands.DELETE_CUSTOMER);
	...
	private void addActionListenerToButtons() {
		...
		this.btnEditCustomer.addActionListener(this.guiCustomerAdminstrationActionListener);
		this.btnDeleteCustomer.addActionListener(this.guiCustomerAdminstrationActionListener);
