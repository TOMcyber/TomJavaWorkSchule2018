...
public final class TextResources {
	...
	public static final String	USER_MSG_SAVED_CUSTOMER_SUCCESSFULLY	= "Saved Customer successfully";
	public static final String	USER_MSG_EDITED_CUSTOMER_SUCCESSFULLY	= "Edited Customer successfully";
	public static final String	USER_MSG_DELETE_CUSTOMER				= "Do you want to delete this customer:\n\n";
	...
	public static final String	LOG_MSG_CUSTOMER_SAVED					= " Customer saved: ";
	public static final String	LOG_MSG_CUSTOMER_EDITED					= " Customer edited: ";
	public static final String	LOG_MSG_CUSTOMER_DELETE					= " Customer deleted: ";
